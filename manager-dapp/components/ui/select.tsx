...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus:outline-none focus:ring-2 focus:ring-[var(--pixel-accent)] focus:ring-offset-2",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    className={cn(
      ...
      "text-[var(--pixel-text-secondary)] transition-colors hover:text-[var(--pixel-text-primary)]",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-sm font-medium text-[var(--pixel-text-secondary)]",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full select-none items-center rounded-sm py-1.5 pl-2 pr-8",
      "text-sm outline-none cursor-pointer",
      "focus:bg-[var(--pixel-accent)] focus:text-white",
