module my_addr::addr_aptos {
    ...
    public fun update_addr_with_chains_and_description(addr_info: &mut AddrInfo, signature: &mut String, pubkey: &mut String, chains: vector<String>, description: String) {
        let addr_info_msg = addr_info::get_msg(addr_info);
        // check msg etmpy
        assert!(addr_info_msg != string::utf8(b""), addr_info::err_addr_info_etmpty());
